...
Rectangle {
    ...
    implicitHeight: {
        ...
        if (selectedTabIndex === 2)
            return headerRow.height + 300 + Theme.spacingM;
    ...
    Row {
        ...
        Row {
            ...
            DankDropdown {
                ...
                anchors.verticalCenter: parent.verticalCenter
                visible: selectedTabIndex === 1 && (NetworkService.wifiDevices?.length ?? 0) > 1
                compactMode: true
                dropdownWidth: 120
                popupWidth: 160
            ...
            DankButtonGroup {
                ...
                model: [I18n.tr("Ethernet"), I18n.tr("WiFi"), I18n.tr("Other")]
                currentIndex: root.selectedTabIndex
                selectionMode: "single"
                onSelectionChanged: (index, selected) => {
                    if (!selected)
                        return;
                    root.selectedTabIndex = index;
                    if (index <= 1)
    ...
    Item {
        ...
        visible: selectedTabIndex === 1 && NetworkService.wifiToggling
    ...
    Item {
        ...
        anchors.margins: Theme.spacingM
        anchors.topMargin: Theme.spacingM
        visible: selectedTabIndex === 1 && !NetworkService.wifiEnabled && !NetworkService.wifiToggling
    ...
    DankFlickable {
        ...
        anchors.margins: Theme.spacingM
        anchors.topMargin: Theme.spacingM
        visible: selectedTabIndex === 0 && NetworkService.backend === "networkmanager" && DMSService.apiVersion > 10
    ...
    Item {
        ...
        anchors.margins: Theme.spacingM
        anchors.topMargin: Theme.spacingM
        visible: selectedTabIndex === 1 && NetworkService.wifiEnabled && !NetworkService.wifiToggling && NetworkService.wifiInterface && (NetworkService.wifiNetworks?.length ?? 0) < 1 && NetworkService.isScanning
    ...
    DankListView {
        ...
        anchors.margins: Theme.spacingM
        anchors.topMargin: Theme.spacingM
        visible: selectedTabIndex === 1 && NetworkService.wifiEnabled && !NetworkService.wifiToggling && !wifiScanningOverlay.visible
        clip: true
        spacing: Theme.spacingS
